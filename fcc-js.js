...
//       const numArab = array[index][1]; // 1000
//       const numRoman = array[index][0]; // M
//       const temp = num2 - numArab;

//       if (temp >= 0) {
//         arrRoman.push(numArab);
//         arrRoman2.push(numRoman);
//       }
//     }
//     num2 = num2 - arrRoman[0];
//     arrRoman2[0] !== undefined ? (result = result + arrRoman2[0]) : "";
...
// // !PLAN:
// // 1. create array of ABC;
// // 2. convert string to array;;
// // 3. create a vatiable to shift;
// // 4. map the array to vatiable;
...
//   const arrCipher = arrStr.map(function (element) {
//     if (arrABC.indexOf(element) >= 0) {
//       if (arrABC.indexOf(element) - keyNumber < 0) {
//         return arrABC[arrABC.indexOf(element) - keyNumber + arrABC.length];
//       } else {
//         return arrABC[arrABC.indexOf(element) - keyNumber];
//       }
//     } else {
//       return element;
//     }
...
//   const regExp =
//     /^[^15(]|^1\d|^\([^15]|^\d{2}\s|^[^(]?\d{3}\)|[a-zA-Z?]|[^(]\d{3}\)|\(\d{3}[^)]|\)$/g;
//   if (regExp.test(str) || str.length < 10) {
//     console.log(false); //
//     return false;
//   }
//   console.log(true); //
